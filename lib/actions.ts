...
const RULES: Rule[] = [
  {
    id: "inhaler",
    textRu: "Проверь, что ингалятор с собой",
    textKk: "Ингалятор жаныңда екенін тексер",
    icon: "backpack",
    priority: 92,
  ...
  {
    id: "windows-closed",
    textRu: "Держи окна закрытыми до вечера",
    textKk: "Терезені кешке дейін жабық ұста",
    icon: "wind",
    priority: 86,
    match: (c) => c.risk >= 7,
  },
  {
    ...
    textKk: "Көшеде — маска немесе қашықтық",
    icon: "shield",
    priority: 82,
    match: (c) => c.risk >= 7,
  },
  {
    id: "ventilate-early",
    textRu: "Проветри до 7:00, потом окна закрой",
    textKk: "Таңертеңгі 7:00-ге дейін желдетіп, сосын жап",
    icon: "wind",
    priority: 80,
  ...
  {
    id: "pollen-avoid",
    textRu: "Пыльца активна — гуляй подальше от цветущих",
    textKk: "Тозаң белсенді — гүлдеген өсімдіктерден алыс серуенде",
    icon: "leaf",
    priority: 75,
  ...
  },
  {
    ...
    textKk: "Бүгінгі жаттығуды — залда өткіз",
    icon: "dumbbell",
    priority: 70,
  ...
  },
  {
    ...
    textRu: "После дождя воздух чище — можно гулять",
  ...
  {
    id: "diary-evening",
    textRu: "Вечером отметь самочувствие — найдём твой порог",
    textKk: "Кешке өзіңді белгіле — саған деген шегіңді табамыз",
    icon: "heart-pulse",
    priority: 38,
    match: () => true,
  },
  {
    id: "calm-day",
    textRu: "День спокойный — можно гулять подольше",
    textKk: "Күні тыныш — ұзағырақ серуендеуге болады",
    icon: "sun",
    priority: 30,
    match: (c) => c.risk <= 3,
  },
